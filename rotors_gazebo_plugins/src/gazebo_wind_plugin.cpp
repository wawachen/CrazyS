...
void GazeboWindPlugin::OnUpdate(const common::UpdateInfo& _info) {
  ...
  if (!use_custom_static_wind_field_) {
    ...
    double wind_strength_x = wind_force_x_;
    double wind_strength_y = wind_force_y_;
    ignition::math::Vector3d wind_direction_x_(1.0,0.0,0.0);
    ignition::math::Vector3d wind_direction_y_(0.0,1.0,0.0);
    ignition::math::Vector3d wind_x = wind_strength_x * wind_direction_x_;
    ignition::math::Vector3d wind_y = wind_strength_y * wind_direction_y_;
    ignition::math::Vector3d wind = wind_x+wind_y;
...
void GazeboWindPlugin::CreatePubsAndSubs() {
  ...
  wind_force_x_sub_ = ros_node_handle_->subscribe<std_msgs::Float32>("/wind_force_x", 1, &GazeboWindPlugin::setWindforce_x,this);
  wind_force_y_sub_ = ros_node_handle_->subscribe<std_msgs::Float32>("/wind_force_y", 1, &GazeboWindPlugin::setWindforce_y,this); 
}

void GazeboWindPlugin::setWindforce_x(const std_msgs::Float32::ConstPtr& msg){
  wind_force_x_ = msg->data;
}

void GazeboWindPlugin::setWindforce_y(const std_msgs::Float32::ConstPtr& msg){
  wind_force_y_ = msg->data;
}
